...
{  
    ...
    case FEATURE_LOWE:  
        ...
        break;  
    default:  
        fprintf( stderr, "Warning: import_features(): unrecognized feature type, %s, line %d\n", __FILE__, __LINE__ );  
        return -1;  
    }  
  
    if( n == -1 )  
        fprintf( stderr, "Warning: unable to import features from %s, %s, line %d\n", filename, __FILE__, __LINE__ );  
    return n;  
}  
...
{  
    ...
    case FEATURE_LOWE:  
        ...
        break;  
    default:  
        fprintf( stderr, "Warning: export_features(): unrecognized feature type, %s, line %d\n", __FILE__, __LINE__ );  
        return -1;  
    }  
  
    if( r )  
        fprintf( stderr, "Warning: unable to export features to %s, %s, line %d\n", filename, __FILE__, __LINE__ );  
    return r;  
}  
...
{  
    ...
    case FEATURE_LOWE:  
        ...
        break;  
    default:  
        fprintf( stderr, "Warning: draw_features(): unrecognized feature type, %s, line %d\n", __FILE__, __LINE__ );  
        break;  
    }     
}  
...
{  
    ...
    {  
        ...
        {  
            ...
            {  
                fprintf( stderr, "Warning: error reading feature descriptor #%d, %s, line %d\n", i+1, __FILE__, __LINE__ );  
                free( f );  
                return -1;  
            }  
            f[i].descr[j] = dv;  
